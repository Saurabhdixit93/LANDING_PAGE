...
export default function HomeRightSide({ width }) {
  return (
    <div className={`${width} relative`}>
      <div className="w-full">
        ...
        <div className="absolute left-[15%] z-1 bottom-[-15%]">
          <svg
            width="535"
            height="445"
            viewBox="0 0 535 445"
        ...
        <img
          src={"/iPhone-13-Pro-Front3.svg"}
          alt="iPhone-13-Pro-Front3"
          className="absolute top-[-0%] left-[28%]"
          style={{ zIndex: "10" }}
        />
      </div>
      <div className="relative left-[22%] max-w-[50px] mt-[-22%]">
